 ...
 */
@Repository
public class TopicDao extends com.whz.dao.BaseDao<Topic> {
	 ...
	 * @return 该论坛下的所有精华主题帖
	 */
	public com.whz.dao.Page getBoardDigestTopics(int boardId,int pageNo,int pageSize){
	 ...
	 */
	public com.whz.dao.Page getPagedTopics(int boardId,int pageNo,int pageSize) {
	 ...
	 * @return 包含分页信息的Page对象
	 */
	public com.whz.dao.Page queryTopicByTitle(String title, int pageNo, int pageSize) {
