...
public class BoardManageController extends BaseController {
	...
	public ModelAndView listBoardTopics(@PathVariable Integer boardId,@RequestParam(value = "pageNo", required = false) Integer pageNo,HttpServletRequest request) {
		ModelAndView view = new ModelAndView();
		User curUser = (User)request.getSession().getAttribute(CommonConstant.CURRENT_ONLINE_USER);
		...
		view.addObject(CommonConstant.CURRENT_ONLINE_USER,curUser);
		if(curUser!=null){
			view.addObject("isAdmin", curUser.isForumAdmin());
		}
